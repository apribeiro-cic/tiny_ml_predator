 ...
 * Title:        arm_nn_mat_mult_nt_interleaved_t_even_s4
                                                             ...
                                                             const int32_t lhs_cols_offset)
{
    ...
    for (; i_items <= (lhs_rows - 4); i_items += 4)
    {
        ...
        for (int i = 0; i < rhs_rows; i++)
        {
            ...
            const mve_pred16_t rmdr_mask = vctp8q(rhs_cols_offset);
            ...
            for (int j = blk_cnt; j > 0; --j)
            {
                ...
                int8x16_t lhs_high, lhs_low;

                lhs_high = vldrbq_s8(ip_row_0);
                ip_row_0 += 16;
                lhs_low = vldrbq_s8(ip_row_0);
                ip_row_0 += 16;
                acc_n0 = vmladavaq_s8(acc_n0, ker_low, lhs_low);
                acc_n0 = vmladavaq_s8(acc_n0, ker_high, lhs_high);

                lhs_high = vldrbq_s8(ip_row_1);
                ip_row_1 += 16;
                lhs_low = vldrbq_s8(ip_row_1);
                ip_row_1 += 16;
                acc_n1 = vmladavaq_s8(acc_n1, ker_low, lhs_low);
                acc_n1 = vmladavaq_s8(acc_n1, ker_high, lhs_high);

                lhs_high = vldrbq_s8(ip_row_2);
                ip_row_2 += 16;
                lhs_low = vldrbq_s8(ip_row_2);
                ip_row_2 += 16;
                acc_n2 = vmladavaq_s8(acc_n2, ker_low, lhs_low);
                acc_n2 = vmladavaq_s8(acc_n2, ker_high, lhs_high);

                lhs_high = vldrbq_s8(ip_row_3);
                ip_row_3 += 16;
                lhs_low = vldrbq_s8(ip_row_3);
                ip_row_3 += 16;
                acc_n3 = vmladavaq_s8(acc_n3, ker_low, lhs_low);
                acc_n3 = vmladavaq_s8(acc_n3, ker_high, lhs_high);
